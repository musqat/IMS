...
TDD로 개발. 총 **409개 테스트** — 백엔드 340 · 프론트 단위 51 · E2E 18.
백엔드는 JaCoCo 기준 **라인 93.8% / 브랜치 86.8%**
...
백엔드 의존성은 Trivy로 스캔합니다. CRITICAL이 하나라도 나오면 PR이 막힙니다.
HIGH는 목록으로만 남깁니다. 아직 패치가 없는 것들이라 막으면 항상 빨간 상태가 됩니다.
