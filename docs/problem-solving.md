...
<details>
<summary><b>멈춘 게 아니라 느린 것이었다.</b> 애플리케이션 로그로는 두 상태가 안 갈린다</summary>
...
고치는 방법은 `ddl-auto`를 걷어내고 마이그레이션 도구로 옮기는 것이다. 배포된 스키마에
맞는 baseline을 정확히 떠야 하고 그 과정에 배포 위험이 있어 지금은 두고 있다.
